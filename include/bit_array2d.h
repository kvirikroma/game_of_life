...
extern uint32_t bit_array2d_coordinates_to_index(bit_array2d* self, int32_t x, int32_t y);

// Returns value of bit by its coordinates
extern bool bit_array2d_get_bit(bit_array2d* self, int32_t x, int32_t y, bool disable_cycle_adressing);
