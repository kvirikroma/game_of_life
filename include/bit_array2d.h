...
extern uint32_t bit_array2d_coordinates_to_index(bit_array2d* array, int32_t x, int32_t y);

// Returns value of bit by its coordinates
extern bool bit_array2d_get_bit(bit_array2d* array, int32_t x, int32_t y);

// Sets bit value by its coordinates
// Returns 1 on success or 0 on error
extern void bit_array2d_set_bit(bit_array2d* array, int32_t x, int32_t y, bool value);
